...
import com.ciberdix.th.model.VDivisionPoliticaRec;
...
public class DivisionPoliticaRefactorController {
    ...
    List<VDivisionPoliticaRec> findLocaliAll(@PathVariable String queryString) {
        RestTemplate restTemplate = new RestTemplate();
        VDivisionPoliticaRec[] parametros = restTemplate.getForObject(serviceUrl + "/buscarLocalizacionesAll/" + queryString + "/", VDivisionPoliticaRec[].class);
        return Arrays.asList(parametros);
    }
    ...
    List<DivisionPolitica> findByPublicacion() {
        RestTemplate restTemplate = new RestTemplate();
        DivisionPolitica[] parametros = restTemplate.getForObject(serviceUrl + "/divisionPublicacion", DivisionPolitica[].class);
        return Arrays.asList(parametros);
    }
}
