 ...
 */
@Entity
@Table(name = "GruposCompetencias", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class GruposCompetenciasEntity {
    ...
    public boolean equals(Object o) {
        ...
        GruposCompetenciasEntity that = (GruposCompetenciasEntity) o;
