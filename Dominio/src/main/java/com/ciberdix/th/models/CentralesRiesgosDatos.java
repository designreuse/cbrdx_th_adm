...
@Entity
@Table(name = "CentralesRiesgosDatos", schema = "dbo", catalog = "CREZCAMOS")
public class CentralesRiesgosDatos {
    ...
    public CentralesRiesgosDatos() {
    }

    public CentralesRiesgosDatos(Integer idCentralRiesgo, Integer idDato, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
    ...
    public CentralesRiesgosDatos(Integer idCentralRiesgoDato, Integer idCentralRiesgo, Integer idDato, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
    ...
    public boolean equals(Object o) {
        ...
        CentralesRiesgosDatos that = (CentralesRiesgosDatos) o;
