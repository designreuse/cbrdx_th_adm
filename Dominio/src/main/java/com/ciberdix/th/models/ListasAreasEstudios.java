 ...
 */
@Entity
@Table(name = "ListasAreasEstudios",schema = "dbo",catalog = "CREZCAMOS")
public class ListasAreasEstudios {
    ...
    public ListasAreasEstudios(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
