 ...
 */
@Entity
@Table(name = "V_TercerosReferencias", schema = "crz_th", catalog = "CREZCAMOS")
public class VTercerosReferenciasEntity {
    ...
    public boolean equals(Object o) {
        ...
        VTercerosReferenciasEntity that = (VTercerosReferenciasEntity) o;
