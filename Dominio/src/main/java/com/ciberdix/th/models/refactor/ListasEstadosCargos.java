...
public class ListasEstadosCargos {
    ...
    @Id
    @Column(name = "IdListaEstadoCargo")
    ...
    public boolean equals(Object o) {
        ...
        if (idListaEstadoCargo != null ? !idListaEstadoCargo.equals(that.idListaEstadoCargo) : that.idListaEstadoCargo != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = idListaEstadoCargo != null ? idListaEstadoCargo.hashCode() : 0;
