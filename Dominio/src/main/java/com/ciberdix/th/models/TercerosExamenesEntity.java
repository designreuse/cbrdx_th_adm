 ...
 */
@Entity
@Table(name = "TercerosExamenes", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class TercerosExamenesEntity {
    ...
    public boolean equals(Object o) {
        ...
        TercerosExamenesEntity that = (TercerosExamenesEntity) o;
