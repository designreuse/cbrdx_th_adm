 ...
 */
@Entity
@Table(name = "TercerosRituales", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class TercerosRitualesEntity {
    ...
    public boolean equals(Object o) {
        ...
        TercerosRitualesEntity that = (TercerosRitualesEntity) o;
