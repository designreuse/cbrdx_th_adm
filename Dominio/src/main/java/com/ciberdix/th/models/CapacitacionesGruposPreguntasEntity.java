 ...
 */
@Entity
@Table(name = "CapacitacionesGruposPreguntas", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class CapacitacionesGruposPreguntasEntity {
    ...
    public boolean equals(Object o) {
        ...
        CapacitacionesGruposPreguntasEntity that = (CapacitacionesGruposPreguntasEntity) o;
