 ...
 */
@Entity
@Table(name = "ListasTiposReferencias", schema = "dbo", catalog = "CREZCAMOS")
public class ListasTiposReferencias {
    ...
    public ListasTiposReferencias(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
