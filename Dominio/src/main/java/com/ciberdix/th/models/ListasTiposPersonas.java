 ...
 */
@Entity
@Table(name = "ListasTiposPersonas", schema = "dbo", catalog = "CREZCAMOS")
public class ListasTiposPersonas {
    ...
    public ListasTiposPersonas(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
