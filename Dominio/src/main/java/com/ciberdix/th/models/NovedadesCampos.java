...
@Entity
@Table(name = "NovedadesCampos", schema = "dbo", catalog = "CREZCAMOS")
public class NovedadesCampos {
    ...
    public NovedadesCampos() {
    }

    public NovedadesCampos(Integer idNovedad, Integer idCampoNovedad, Boolean indicadorObligatorio, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
    ...
    public NovedadesCampos(Integer idNovedadCampo, Integer idNovedad, Integer idCampoNovedad, Boolean indicadorObligatorio, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
    ...
    public boolean equals(Object o) {
        ...
        NovedadesCampos that = (NovedadesCampos) o;
