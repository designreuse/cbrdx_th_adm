 ...
 */
@Entity
@Table(name = "ListasExamenes", schema = "dbo", catalog = "CREZCAMOS")
public class ListasExamenes {
    ...
    public ListasExamenes() {
    }

    public ListasExamenes(String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.orden = orden;
    ...
    public ListasExamenes(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
