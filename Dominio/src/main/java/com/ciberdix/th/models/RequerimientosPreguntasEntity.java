 ...
 */
@Entity
@Table(name = "RequerimientosPreguntas", schema = "crz_th", catalog = "CREZCAMOS")
public class RequerimientosPreguntasEntity {
    ...
    public boolean equals(Object o) {
        ...
        RequerimientosPreguntasEntity that = (RequerimientosPreguntasEntity) o;
