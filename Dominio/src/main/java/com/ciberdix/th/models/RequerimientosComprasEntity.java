 ...
 */
@Entity
@Table(name = "RequerimientosCompras", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class RequerimientosComprasEntity {
    ...
    public boolean equals(Object o) {
        ...
        RequerimientosComprasEntity that = (RequerimientosComprasEntity) o;
