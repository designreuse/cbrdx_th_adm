 ...
 */
@Entity
@Table(name = "ListasIntensidades", schema = "dbo", catalog = "CREZCAMOS")
public class ListasIntensidades {
    ...
    public ListasIntensidades(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
