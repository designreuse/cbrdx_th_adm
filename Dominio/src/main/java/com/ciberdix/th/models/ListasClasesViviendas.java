 ...
 */
@Entity
@Table(name = "ListasClasesViviendas", catalog = "CREZCAMOS", schema = "dbo")
public class ListasClasesViviendas {
    ...
    public ListasClasesViviendas(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
