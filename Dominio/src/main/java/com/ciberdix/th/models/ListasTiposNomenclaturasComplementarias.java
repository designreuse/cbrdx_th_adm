 ...
 */
@Entity
@Table(name = "ListasTiposNomenclaturasComplementarias", schema = "dbo", catalog = "CREZCAMOS")
public class ListasTiposNomenclaturasComplementarias {
    ...
    public ListasTiposNomenclaturasComplementarias(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
