 ...
 */
@Entity
@Table(name = "TercerosAdaptacionesLaborales", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class TercerosAdaptacionesLaboralesEntity {
    ...
    public boolean equals(Object o) {
        ...
        TercerosAdaptacionesLaboralesEntity that = (TercerosAdaptacionesLaboralesEntity) o;
