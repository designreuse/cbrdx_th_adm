 ...
 */
@Entity
@Table(name = "ListasEstadosJuridicos", schema = "dbo", catalog = "CREZCAMOS")
public class ListasEstadosJuridicos {
    ...
    public ListasEstadosJuridicos(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
