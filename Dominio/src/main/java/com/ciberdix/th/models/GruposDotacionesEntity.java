 ...
 */
@Entity
@Table(name = "GruposDotaciones", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class GruposDotacionesEntity {
    ...
    public boolean equals(Object o) {
        ...
        GruposDotacionesEntity that = (GruposDotacionesEntity) o;
