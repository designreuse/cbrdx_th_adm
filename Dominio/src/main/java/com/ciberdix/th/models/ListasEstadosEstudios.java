 ...
 */
@Entity
@Table(name = "ListasEstadosEstudios", schema = "dbo", catalog = "CREZCAMOS")
public class ListasEstadosEstudios {
    ...
    public ListasEstadosEstudios(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
