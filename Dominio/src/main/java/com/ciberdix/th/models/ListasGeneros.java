 ...
 */
@Entity
@Table(name = "ListasGeneros", schema = "dbo", catalog = "CREZCAMOS")
public class ListasGeneros {
    ...
    public ListasGeneros(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
