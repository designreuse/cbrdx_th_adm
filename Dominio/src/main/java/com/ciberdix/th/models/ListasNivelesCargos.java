 ...
 */
@Entity
@Table(name = "ListasNivelesCargos", schema = "dbo", catalog = "CREZCAMOS")
public class ListasNivelesCargos {
    ...
    public ListasNivelesCargos(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
