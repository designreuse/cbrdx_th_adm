 ...
 */
@Entity
@Table(name = "BeneficiosSolicitudes", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class BeneficiosSolicitudesEntity {
    ...
    public boolean equals(Object o) {
        ...
        BeneficiosSolicitudesEntity that = (BeneficiosSolicitudesEntity) o;
