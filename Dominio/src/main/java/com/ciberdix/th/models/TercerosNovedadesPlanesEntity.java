 ...
 */
@Entity
@Table(name = "TercerosNovedadesPlanes", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class TercerosNovedadesPlanesEntity {
    ...
    public boolean equals(Object o) {
        ...
        TercerosNovedadesPlanesEntity that = (TercerosNovedadesPlanesEntity) o;
