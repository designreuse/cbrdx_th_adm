 ...
 */
@Entity
@Table(name = "ListasClasificacionesSedes", schema = "dbo", catalog = "CREZCAMOS")
public class ListasClasificacionesSedes {
    ...
    public ListasClasificacionesSedes(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
