 ...
 */
@Entity
@Table(name = "GruposFormaciones", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class GruposFormacionesEntity {
    ...
    public boolean equals(Object o) {
        ...
        GruposFormacionesEntity that = (GruposFormacionesEntity) o;
