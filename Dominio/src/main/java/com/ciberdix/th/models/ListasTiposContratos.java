 ...
 */
@Entity
@Table(name = "ListasTiposContratos", schema = "dbo", catalog = "CREZCAMOS")
public class ListasTiposContratos {
    ...
    public ListasTiposContratos(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
