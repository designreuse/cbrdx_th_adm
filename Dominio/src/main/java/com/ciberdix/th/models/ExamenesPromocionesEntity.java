 ...
 */
@Entity
@Table(name = "ExamenesPromociones", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class ExamenesPromocionesEntity {
    ...
    @Basic
    @Column(name = "ExamenPromocion", nullable = true, length = 50)
    ...
    public boolean equals(Object o) {
        ...
        ExamenesPromocionesEntity that = (ExamenesPromocionesEntity) o;
