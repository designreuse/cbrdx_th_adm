 ...
 */
@Entity
@Table(name = "ListasLateralidades", schema = "dbo", catalog = "CREZCAMOS")
public class ListasLateralidades {
    ...
    public ListasLateralidades(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
