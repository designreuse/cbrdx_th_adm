 ...
 */
@Entity
public class ExamenesPromocionesPreguntasRespuestas {
    ...
    @Id
    @Column(name = "IdExamenPromocionPreguntaRespuesta")
    ...
    public boolean equals(Object o) {
        ...
        ExamenesPromocionesPreguntasRespuestas that = (ExamenesPromocionesPreguntasRespuestas) o;
