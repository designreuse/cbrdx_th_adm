 ...
 */
@Entity
@Table(name = "ListasInstituciones", schema = "dbo", catalog = "CREZCAMOS")
public class ListasInstituciones {
    ...
    public ListasInstituciones(String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.orden = orden;
    ...
    public ListasInstituciones(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
