 ...
 */
@Entity
@Table(name = "ListasNivelesEstudios", schema = "dbo", catalog = "CREZCAMOS")
public class ListasNivelesEstudios {
    ...
    public ListasNivelesEstudios(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
