 ...
 */
@Entity
@Table(name = "DivisionPoliticaLocalidades", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class DivisionPoliticaLocalidades {
    ...
    public boolean equals(Object o) {
        ...
        DivisionPoliticaLocalidades that = (DivisionPoliticaLocalidades) o;
    ...
    @Override
    public int hashCode() {
        int result = idDivisionPoliticaLocalidad != null ? idDivisionPoliticaLocalidad.hashCode() : 0;
