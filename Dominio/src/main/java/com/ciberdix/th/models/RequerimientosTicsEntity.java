 ...
 */
@Entity
@Table(name = "RequerimientosTICS", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class RequerimientosTicsEntity {
    ...
    public boolean equals(Object o) {
        ...
        RequerimientosTicsEntity that = (RequerimientosTicsEntity) o;
