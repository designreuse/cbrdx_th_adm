...
public class ProyeccionDotacion {
    ...
    public ProyeccionDotacion(Integer idProyeccionDotacion, String nombreProyeccion, Integer idGrupoDotacion, Boolean indicadorAdicional, Boolean indicadorNoAreas, Integer cantidadProyeccion, Integer cantidadMeses, Date fechaInicio, Date fechaFin, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
