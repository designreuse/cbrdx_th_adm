 ...
 */
@Entity
@Table(name = "V_Localizaciones", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class VLocalizaciones {
    ...
    public boolean equals(Object o) {
        ...
        VLocalizaciones that = (VLocalizaciones) o;
        ...
        if (idDivisionPolitica != null ? !idDivisionPolitica.equals(that.idDivisionPolitica) : that.idDivisionPolitica != null)
            return false;
        if (divisionPolitica != null ? !divisionPolitica.equals(that.divisionPolitica) : that.divisionPolitica != null)
            return false;
