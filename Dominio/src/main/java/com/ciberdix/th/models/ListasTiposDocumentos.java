 ...
 */
@Entity
@Table(name = "ListasTiposDocumentos", schema = "dbo", catalog = "CREZCAMOS")
public class ListasTiposDocumentos {
    ...
    public ListasTiposDocumentos(Integer idLista, String codigo, String nombre, Integer orden, Boolean indicadorHabilitado, Integer auditoriaUsuario) {
