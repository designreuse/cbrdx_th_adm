 ...
 */
@Entity
@Table(name = "UsuarioGruposGestion", schema = "crz_th", catalog = "CREZCAMOS_TEST")
public class UsuarioGruposGestionEntity {
    ...
    public boolean equals(Object o) {
        ...
        UsuarioGruposGestionEntity that = (UsuarioGruposGestionEntity) o;
